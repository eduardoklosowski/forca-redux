...
/***/ function(module, exports, __webpack_require__) {
	...
	var _forca = __webpack_require__(184);

	var _forca2 = _interopRequireDefault(_forca);

	var _opcoes = __webpack_require__(185);

	var _opcoes2 = _interopRequireDefault(_opcoes);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var reduceApp = (0, _redux.combineReducers)({
	  forca: _forca2.default,
	  opcoes: _opcoes2.default
	});
...
/***/ function(module, exports) {
	...
	var removeAcentuacao = function removeAcentuacao(palavra) {
	  var normalizada = palavra.normalize('NFKD');
	  var limpa = [];
	  var len = normalizada.length;
	  var i = void 0;
	...
	var lengthWithoutSpaces = function lengthWithoutSpaces(palavra) {
	  return palavra.replace(/\s+/g, '').length;
	};

	var calcFaltando = function calcFaltando(palavra, letras) {
	  var faltando = palavra.length;
	  var i = void 0;
	  var letra = void 0;
	...
	var setPalavra = function setPalavra(action) {
	  var palavra = action.palavra.trim().toLowerCase().replace(/\s+/g, ' ');
	...
	var addLetra = function addLetra(action, state) {
	  var letra = removeAcentuacao(action.letra.slice(0, 1).toLowerCase());

	  if (state.letras.indexOf(letra) >= 0) {
	    return state;
	  }

	  var letras = state.letras.concat(letra);
	  var vidas = state.vidas;
	  var faltando = state.faltando;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Forca = __webpack_require__(187);

	var _Forca2 = _interopRequireDefault(_Forca);

	var _LetraInput = __webpack_require__(188);

	var _LetraInput2 = _interopRequireDefault(_LetraInput);

	var _Letras = __webpack_require__(190);

	var _Letras2 = _interopRequireDefault(_Letras);

	var _Palavra = __webpack_require__(191);

	var _Palavra2 = _interopRequireDefault(_Palavra);

	var _PalavraInput = __webpack_require__(192);

	var _PalavraInput2 = _interopRequireDefault(_PalavraInput);
	...
	var App = function App(_ref) {
	  var completo = _ref.completo;
	  var vidas = _ref.vidas;
	  var palavra = _ref.palavra;
	  var palavraLimpa = _ref.palavraLimpa;
	  var letras = _ref.letras;

	  var conteudo = '';

	  if (palavra) {
	    conteudo = _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(_Forca2.default, { vidas: vidas, completo: completo }),
	      _react2.default.createElement(_Palavra2.default, { vidas: vidas, palavra: palavra, palavraLimpa: palavraLimpa, letras: letras }),
	      !completo && vidas ? _react2.default.createElement(_LetraInput2.default, null) : '',
	      _react2.default.createElement(_Letras2.default, { palavraLimpa: palavraLimpa, letras: letras })
	    );
	  }
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'app' },
	    palavra ? conteudo : _react2.default.createElement(_Forca2.default, { vidas: 0, completo: false }),
	    completo || !vidas ? _react2.default.createElement(_PalavraInput2.default, null) : ''
	  );
	};
	App.propTypes = {
	  completo: _react.PropTypes.bool.isRequired,
	  vidas: _react.PropTypes.number.isRequired,
	  palavra: _react.PropTypes.string,
	  palavraLimpa: _react.PropTypes.string,
	  letras: _react.PropTypes.arrayOf(_react.PropTypes.string).isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _forca = __webpack_require__(189);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    action: function action(letra) {
	      return dispatch((0, _forca.addLetra)(letra));
	    }
	  };
	};

	var LetraInput = function LetraInput(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement('input', { ref: function ref(node) {
	        input = node;
	      }, type: 'text', placeholder: 'Letra', maxLength: '1' }),
	...
	LetraInput = (0, _reactRedux.connect)(undefined, mapDispatchToProps)(LetraInput);

	exports.default = LetraInput;
...
/***/ function(module, exports) {
	...
	var setPalavra = exports.setPalavra = function setPalavra(palavra) {
	  return {
	    type: 'SET_PALAVRA',
	    palavra: palavra
	  };
	...
	var addLetra = exports.addLetra = function addLetra(letra) {
	  return {
	    type: 'ADD_LETRA',
	    letra: letra
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Letras = function Letras(_ref) {
	  var palavraLimpa = _ref.palavraLimpa;
	  var letras = _ref.letras;
	  return _react2.default.createElement(
	    "div",
	    ...
	    _react2.default.createElement(
	      ...
	      letras.map(function (l, i) {
	        return _react2.default.createElement(
	          "li",
	          { key: i, className: palavraLimpa.indexOf(l) >= 0 ? 'certa' : 'errada' },
	          l
	        );
	      })
	    )
	...
	Letras.propTypes = {
	  palavraLimpa: _react.PropTypes.string.isRequired,
	  letras: _react.PropTypes.arrayOf(_react.PropTypes.string).isRequired
	};

	exports.default = Letras;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var palavraToArray = function palavraToArray(str) {
	  var array = [];
	  var c = void 0;
	...
	var Palavra = function Palavra(_ref) {
	  var vidas = _ref.vidas;
	  var palavra = _ref.palavra;
	  var palavraLimpa = _ref.palavraLimpa;
	  var letras = _ref.letras;
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'ul',
	      null,
	      palavraToArray(palavraLimpa).map(function (l, i) {
	        if (l === ' ') {
	          return _react2.default.createElement(
	            'li',
	            { key: i, className: 'espaco' },
	            ' '
	          );
	        }
	        var acertada = letras.indexOf(l) >= 0;
	        return _react2.default.createElement(
	          'li',
	          { key: i, className: !acertada && !vidas ? 'faltou' : '' },
	...
	Palavra.propTypes = {
	  vidas: _react.PropTypes.number.isRequired,
	  palavra: _react.PropTypes.string.isRequired,
	  palavraLimpa: _react.PropTypes.string.isRequired,
	  letras: _react.PropTypes.arrayOf(_react.PropTypes.string).isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _opcoes = __webpack_require__(193);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    action: function action(palavra) {
	      return dispatch((0, _forca.setPalavra)(palavra));
	    },
	    toggleEsconde: function toggleEsconde() {
	      return dispatch((0, _opcoes.toggleEscondePalavra)());
	    }
	  };
	};

	var PalavraInput = function PalavraInput(_ref) {
	  var escondePalavra = _ref.escondePalavra;
	  var action = _ref.action;
	  var toggleEsconde = _ref.toggleEsconde;
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'label',
	      null,
	      _react2.default.createElement('input', { type: 'checkbox', onChange: toggleEsconde, checked: escondePalavra }),
	      'Esconder Palavra?'
	    )
	  );
	};
	PalavraInput.propTypes = {
	  escondePalavra: _react.PropTypes.bool.isRequired,
	  action: _react.PropTypes.func.isRequired,
	  toggleEsconde: _react.PropTypes.func.isRequired
	};

	PalavraInput = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(PalavraInput);

	exports.default = PalavraInput;
...
/***/ function(module, exports) {
	...
	var toggleEscondePalavra = exports.toggleEscondePalavra = function toggleEscondePalavra() {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./forca.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./forca.css");
